package com.neuqsoft.rest.common.aspect;
...
import com.neuqsoft.rest.common.utils.HttpContextUtils;
import com.neuqsoft.rest.common.utils.IPUtils;
...
public class SysLogAspect {
	...
	@Pointcut("@annotation(com.neuqsoft.rest.common.annotation.SysLog)")
	...
	private void saveSysLog(ProceedingJoinPoint joinPoint, long time) {
		...
		com.neuqsoft.rest.common.annotation.SysLog syslog = method.getAnnotation(com.neuqsoft.rest.common.annotation.SysLog.class);
		if (syslog != null) {
			//注解上的描述
